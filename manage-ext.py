        ...
        def init_database(self):
            ...
            if cursor.fetchone()[0] == 0:
                ...
                default_extensions = [
                    ...
                    ("DEV Tools", "2.0.0", "Muap Team", "Developer tools and utilities", 0, datetime.now().strftime("%Y-%m-%d %H:%M:%S"), "0x00065"),
                    ...
                    ("Diagram Beta", "0.9.0", "Muap Team", "Diagram creation and editing (beta version)", 0, datetime.now().strftime("%Y-%m-%d %H:%M:%S"), "0x00068"),
                    ...
                    ("Enhanced User", "1.0.0", "Muap Team", "Enhanced user functionality (user++)", 0, datetime.now().strftime("%Y-%m-%d %H:%M:%S"), "0x00071"),
                    ...
                    ("File Copy Operations", "1.0.0", "Muap Team", "File copying operations only", 0, datetime.now().strftime("%Y-%m-%d %H:%M:%S"), "0x00076"),
                    ...
                    ("Knowledge Base Retro", "1.0.0", "Muap Team", "Retro knowledge base manager", 0, datetime.now().strftime("%Y-%m-%d %H:%M:%S"), "0x00086"),
                    ...
                    ("ZIP Password Recovery", "1.0.0", "Muap Team", "ZIP password recovery tool", 0, datetime.now().strftime("%Y-%m-%d %H:%M:%S"), "0x00124"),
                ]
